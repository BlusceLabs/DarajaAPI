...
<div class="table-wrap">
    ...
    <table id="txTable">
        ...
        <?php foreach (array_reverse($entries) as $i => $e):
            ...
            $providerNames = ['tinypesa' => 'TinyPesa', 'daraja' => 'Daraja', 'pesapal' => 'PesaPal', 'flutterwave' => 'Flutterwave', 'paystack' => 'Paystack', 'mtnmomo' => 'MTN MoMo', 'airtelmoney' => 'Airtel Money', 'dpopay' => 'DPO Pay', 'ozow' => 'Ozow', 'cinetpay' => 'CinetPay', 'paymob' => 'Paymob', 'ecocash' => 'Ecocash', 'orangemoney' => 'Orange Money', 'cellulant' => 'Cellulant Tingg'];
            $providerLabel = $providerNames[$provider] ?? ucfirst($provider);
            $providerLogos = ['tinypesa' => '/logos/tinypesa.png', 'daraja' => '/logos/daraja.svg', 'pesapal' => '/logos/pesapal.png', 'flutterwave' => '/logos/flutterwave_32.png', 'paystack' => '/logos/paystack.png', 'mtnmomo' => '/logos/mtnmomo.svg', 'airtelmoney' => '/logos/airtelmoney.png', 'dpopay' => '/logos/dpopay.png', 'ozow' => '/logos/ozow.png', 'cinetpay' => '/logos/cinetpay.svg', 'paymob' => '/logos/paymob.svg', 'ecocash' => '/logos/ecocash.svg', 'orangemoney' => '/logos/orangemoney.svg', 'cellulant' => '/logos/cellulant.svg'];
